function verificar() {
    ...
    if (l1 >= l2 + l3 || l2 >= l3 + l1 || l3 >= l2 + l1){
        ...
        res.innerHTML = `Esse triângulo é equilátero e possui área ${a.toFixed(2)}.`
    } else if (l1 == l2 || l2 == l3 || l1 == l3){
        res.innerHTML = `Esse triângulo é isósceles e possui área ${a.toFixed(2)}.`
    } else if (l1 != l2 && l2 != l3 && l3 != l1){
        res.innerHTML = `Esse triângulo é escaleno e possui área ${a.toFixed(2)}.`
    }
